...
\section{Composition of an Actor}
...
\end{lstlisting}
\section{Communicating with an Actor}
...
\begin{figure}[H]
    ...
    \end{centering}
\end{figure}
\section{Remote Spawning Mechanism}
