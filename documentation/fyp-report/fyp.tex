...
\begin{figure}[H]
    \begin{centering}
        \includegraphics[width=\textwidth]{resources/actors.png}
...
\begin{figure}[H]
    \begin{centering}
        ...
        \caption{WebSocket Server Connecting Node.js Instance to a Browser with Workers}
    \end{centering}
\end{figure}
...
\begin{figure}[H]
    \begin{centering}
        ...
        \caption{Flowchart for which Link to Choose based on Actor Location}
    \end{centering}
\end{figure}
